...
Transaction = mongoose.model('Transaction', altSchema);
...
client.getBlockHash(169328, 5, function(err, blockhash) {
...
address_array.push('DMz1L4XUtskrpJyivLdUgpPURxuvEVpW57');
